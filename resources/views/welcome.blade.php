...
@section('content')
<style>
    /* button categori pas belum diklik */
    .btn-custom {
...
.comment-list-modal .komentar-container {
  
    max-height: 60vh; 
    overflow-y: auto; 
}

.comment-list-modal .komentar-title {
    display: block;
    white-space: nowrap;
    overflow: hidden;
...
.comment-list-modal ul.custom-ul {
    list-style-type: none;
    padding: 0;
}

.comment-list-modal ul.custom-ul li {
    margin-bottom: 10px;
}
    
</style>

<div class="jumbotron" style="background-color: #E8D8C4;">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-8">
                ...
                <div class="col-4">
                    <div class="dropdown">
                        <form action="{{ route('home') }}" method="GET" id="categoryForm">
                            <button class="btn btn-custom dropdown-toggle w-100" type="button" id="dropdownMenuButton" data-toggle="dropdown">
                                Kategori
                            </button>
                ...
                @foreach($fotos as $foto)
                    <div class="container p-3" id="container-{{ $foto->id }}">
                            <h5 class="nama-user-h5" style="position: relative;">
                                ...
                                <span class="badge badge-pill" style="position: absolute; top: 0; right: 0; background-color: #6D2932; color: white;">
                        ...
                        @auth
                        <div class="custom-margin" style="cursor:pointer;" onclick="openCommentListModal({{ $foto->id }})">Lihat semua komentar: {{ $foto->commentsCount }}</div>
                        @endauth
