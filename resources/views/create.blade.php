...
@section('content')
<div class="jumbotron" style="background-color: #F4EEE7;">
   <div class="card">
            ...
            <div class="card col-12" id="kategori_lainnya" style="display: none;">
               <div class="row">
                  <div class="card-body">
                        ...
                        <input type="text" name="kategori_lainnya" id="kategori_lainnya_input" class="form-control" placeholder="Masukan Kategori Lainnya...">
                  </div>
               </div>
            </div>
            <!-- form lainnya  -->
